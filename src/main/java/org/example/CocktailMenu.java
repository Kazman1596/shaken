...
public class CocktailMenu {
    ...
    public void updateRecipePrompt(Scanner in) {
        ...
        Recipe recipe = jdbcRecipeDao.updateRecipe(recipeToUpdate);
    ...
    public void deleteRecipePrompt(Scanner in) {
        ...
        while (true) {
            ...
            if (choice.equals(YES)) {
                int deletedRows = jdbcRecipeDao.deleteRecipe(recipeToDelete.getRecipeId());
                System.out.println("Successfully deleted " + deletedRows + " cocktail");
                break;
